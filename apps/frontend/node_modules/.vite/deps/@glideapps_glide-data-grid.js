import {
  ...
  useTheme,
  withAlpha
} from "./chunk-C3UNANIK.js";
import {
  styled_default
} from "./chunk-XEZXPWSV.js";
import {
  __commonJS,
  __publicField,
  __toESM,
...
var require_Carousel = __commonJS({
  "node_modules/react-responsive-carousel/lib/js/components/Carousel/index.js"(exports) {
    ...
    var Carousel2 = function(_React$Component) {
...
var ImageOverlayEditorStyle = styled_default("div")({
...
var ImageOverlayEditor = (p2) => {
  ...
  return React2.createElement(
    ...
    React2.createElement(import_react_responsive_carousel.Carousel, { showArrows: allowMove, showThumbs: false, swipeable: allowMove, emulateTouch: allowMove, infiniteLoop: allowMove }, filtered.map((url) => {
      const innerContent = (renderImage == null ? void 0 : renderImage(url)) ?? React2.createElement("img", { draggable: false, src: url });
...
var MarkdownContainer = styled_default("div")({
...
var InputBox = styled_default("textarea")({
  name: "InputBox",
  class: "gdg-izpuzkl",
  propsAsIs: false
});
var ShadowBox = styled_default("div")({
  name: "ShadowBox",
  class: "gdg-s69h75o",
  propsAsIs: false
});
var GrowingEntryStyle = styled_default("div")({
...
function T(l, s, e, c, t, f, a, g) {
  ...
  if (t < e) return -1;
  let n = Math.floor(e / t * f), r = p(l, s.slice(0, Math.max(0, n)), c, a), o = g == null ? void 0 : g(s);
  if (r !== e) if (r < e) {
...
function makeCacheKey(s, ctx, baseline, font) {
  return `${s}_${font ?? (ctx == null ? void 0 : ctx.font)}_${baseline}`;
}
...
function drawMultiLineText(ctx, data, x, y, w2, h, bias, theme, contentAlign, hyperWrapping) {
  ...
  const split = _(ctx, data, fontStyle, w2 - theme.cellHorizontalPadding * 2, hyperWrapping ?? false);
...
function measureCell(ctx, cell, theme, getCellRenderer) {
  ...
  return ((_a = r == null ? void 0 : r.measure) == null ? void 0 : _a.call(r, ctx, cell, theme)) ?? defaultSize;
}
...
function walkGroups(effectiveCols, width, translateX, groupHeaderHeight, cb) {
  ...
  for (let index = 0; index < effectiveCols.length; index++) {
    ...
    cb([startCol.sourceIndex, effectiveCols[end - 1].sourceIndex], startCol.group ?? "", localX + delta, 0, w2, groupHeaderHeight);
    x += boxWidth;
  }
}
function getSpanBounds(span, cellX, cellY, cellW, cellH, column, allColumns) {
  ...
  let frozenRect;
  let contentRect;
  const firstNonSticky = ((_a = allColumns.find((x) => !x.sticky)) == null ? void 0 : _a.sourceIndex) ?? 0;
...
function drawCells(ctx, effectiveColumns, allColumns, height, totalHeaderHeight, translateX, translateY, cellYOffset, rows, getRowHeight, getCellContent, getGroupDetails, getRowThemeOverride, disabledRows, isFocused, drawFocus, freezeTrailingRows, hasAppendRow, drawRegions, damage, selection, prelightCells, highlightRegions, imageLoader, spriteManager, hoverValues, hoverInfo, drawCellCallback, hyperWrapping, outerTheme, enqueue, renderStateProvider, getCellRenderer, overrideCursor, minimumCellWidth) {
  let toDraw = (damage == null ? void 0 : damage.size) ?? Number.MAX_SAFE_INTEGER;
  ...
  walkColumns(effectiveColumns, cellYOffset, translateX, translateY, totalHeaderHeight, (c, drawX, colDrawStartY, clipX, startRow) => {
    ...
    walkRowsInCol(startRow, colDrawStartY, height, rows, getRowHeight, freezeTrailingRows, hasAppendRow, skipPoint, (drawY, row, rh, isSticky, isTrailingRow) => {
      ...
      const trailingTheme = isTrailingRow && ((_a = c.trailingRowOptions) == null ? void 0 : _a.themeOverride) !== void 0 ? (_b = c.trailingRowOptions) == null ? void 0 : _b.themeOverride : void 0;
      ...
      if (drawingSpan) {
        ctx.restore();
        (_c = prepResult == null ? void 0 : prepResult.deprep) == null ? void 0 : _c.call(prepResult, deprepArg);
        prepResult = void 0;
        reclip();
        font = colFont;
        ctx.font = colFont;
...
function drawCell(ctx, cell, col, row, isLastCol, isLastRow, x, y, w2, h, highlighted, theme, finalCellFillColor, imageLoader, spriteManager, hoverAmount, hoverInfo, hyperWrapping, frameTime, drawCellCallback, lastPrep, enqueue, renderStateProvider, getCellRenderer, overrideCursor) {
  var _a, _b;
  let hoverX;
  let hoverY;
...
function drawGridHeaders(ctx, effectiveCols, enableGroups, hovered, width, translateX, headerHeight, groupHeaderHeight, dragAndDropState, isResizing, selection, outerTheme, spriteManager, hoverValues, verticalBorder, getGroupDetails, damage, drawHeaderCallback, touchMode) {
  ...
  const [hCol, hRow] = (hovered == null ? void 0 : hovered[0]) ?? [];
  ...
  walkColumns(effectiveCols, 0, translateX, 0, totalHeaderHeight, (c, x, _y, clipX) => {
    ...
    const hover = noHover ? 0 : ((_a = hoverValues.find((s) => s.item[0] === c.sourceIndex && s.item[1] === -1)) == null ? void 0 : _a.hoverAmount) ?? 0;
...
function drawGroups(ctx, effectiveCols, width, translateX, groupHeaderHeight, hovered, theme, spriteManager, _hoverValues, verticalBorder, getGroupDetails, damage) {
  ...
  walkGroups(effectiveCols, width, translateX, groupHeaderHeight, (span, groupName, x, y, w2, h) => {
    ...
    const groupTheme = (group == null ? void 0 : group.overrideTheme) === void 0 ? theme : mergeAndRealizeTheme(theme, group.overrideTheme);
    ...
    if (group !== void 0) {
      ...
      if (group.actions !== void 0 && isHovered) {
        ...
        ctx.fill();
        ctx.globalAlpha = 0.6;
        const [mouseX, mouseY] = (hovered == null ? void 0 : hovered[1]) ?? [-1, -1];
...
function drawHeaderInner(ctx, x, y, width, height, c, selected, theme, isHovered, hoverAmount, spriteManager, touchMode, isRtl, menuBounds) {
  if (c.rowMarker !== void 0) {
    ...
    drawCheckbox(ctx, theme, checked, x, y, width, height, false, void 0, void 0, 18, "center", c.rowMarker);
    if (checked !== true) {
      ctx.globalAlpha = 1;
    }
    return;
    ...
    while (y + translateY < target) {
      ...
      if (ty >= minY && ty <= maxY - 1) {
        ...
        toDraw.push({
          ...
          x2: maxX,
          y2: ty,
          color: (rowTheme == null ? void 0 : rowTheme.horizontalBorderColor) ?? (rowTheme == null ? void 0 : rowTheme.borderColor) ?? hColor
        });
      }
      y += getRowHeight(row);
      row++;
    ...
    walkRowsInCol(startRow, colDrawY, height, rows, getRowHeight, freezeTrailingRows, hasAppendRow, void 0, (drawY, row, rh) => {
      ...
      if (doHandle) {
        drawHandleCb = () => {
          ...
          ctx.fillStyle = ((_a = col.themeOverride) == null ? void 0 : _a.accentColor) ?? theme.accentColor;
          ctx.fill();
        };
      }
...
function drawGrid(arg, lastArg) {
  ...
  let drawRegions = [];
  const mustDrawFocusOnHeader = drawFocus && ((_a = selection.current) == null ? void 0 : _a.cell[1]) === cellYOffset && translateY === 0;
...
var AnimationManager = class {
  constructor(callback) {
    ...
    __publicField(this, "removeFromLeavingItems", (item) => {
      ...
      return (leavingItem == null ? void 0 : leavingItem.hoverAmount) ?? 0;
    });
...
var getRowData = (cell, getCellRenderer) => {
  ...
  return (r == null ? void 0 : r.getAccessibilityString(cell)) ?? "";
};
var DataGrid = (p2, forwardedRef) => {
  ...
  const enableFirefoxRescaling = ((experimental == null ? void 0 : experimental.enableFirefoxRescaling) ?? false) && browserIsFirefox.value;
  const enableSafariRescaling = ((experimental == null ? void 0 : experimental.enableSafariRescaling) ?? false) && browserIsSafari.value;
  ...
  const draw = React8.useCallback(() => {
    ...
    const current = {
      ...
      spriteManager,
      scrolling,
      hyperWrapping: (experimental == null ? void 0 : experimental.hyperWrapping) ?? false,
      touchMode: lastWasTouch,
      enqueue: enqueueRef.current,
      renderStateProvider,
      renderStrategy: (experimental == null ? void 0 : experimental.renderStrategy) ?? (browserIsSafari.value ? "double-buffer" : "single-buffer"),
      getCellRenderer,
      minimumCellWidth
    };
    ...
    if (!didOverride && (current.damage === void 0 || current.damage.has((_a = hoverInfoRef == null ? void 0 : hoverInfoRef.current) == null ? void 0 : _a[0]))) {
  ...
  const onMouseUpImpl = React8.useCallback((ev) => {
    ...
    if (args.kind === headerKind && headerBounds !== void 0) {
      if (args.button !== 0 || ((_a = downPosition.current) == null ? void 0 : _a[0]) !== col || ((_b = downPosition.current) == null ? void 0 : _b[1]) !== -1) {
        onMouseUp(args, true);
      }
      return;
    } else if (args.kind === groupHeaderKind) {
  ...
  useEventListener("contextmenu", onContextMenuImpl, (eventTargetRef == null ? void 0 : eventTargetRef.current) ?? null, false);
  ...
  const onMouseMoveImpl = React8.useCallback((ev) => {
    ...
    if (!mouseEventArgsAreEqual(args, hoveredRef.current)) {
      ...
      if (args.kind === "cell") {
        ...
        const rendererNeeds = (_a = getCellRenderer(toCheck)) == null ? void 0 : _a.needsHoverPosition;
  ...
  useEventListener("dragstart", onDragStartImpl, (eventTargetRef == null ? void 0 : eventTargetRef.current) ?? null, false, false);
  ...
  useEventListener("dragover", onDragOverImpl, (eventTargetRef == null ? void 0 : eventTargetRef.current) ?? null, false, false);
  const onDragEndImpl = React8.useCallback(() => {
    activeDropTarget.current = void 0;
    onDragEnd == null ? void 0 : onDragEnd();
  }, [onDragEnd]);
  useEventListener("dragend", onDragEndImpl, (eventTargetRef == null ? void 0 : eventTargetRef.current) ?? null, false, false);
  ...
  useEventListener("drop", onDropImpl, (eventTargetRef == null ? void 0 : eventTargetRef.current) ?? null, false, false);
  const onDragLeaveImpl = React8.useCallback(() => {
    onDragLeave == null ? void 0 : onDragLeave();
  }, [onDragLeave]);
  useEventListener("dragleave", onDragLeaveImpl, (eventTargetRef == null ? void 0 : eventTargetRef.current) ?? null, false, false);
  ...
  const accessibilityTree = useDebouncedMemo(() => {
    ...
    if (!firstColAccessible && ((_a = effectiveCols[0]) == null ? void 0 : _a.sourceIndex) === 0) {
      effectiveCols = effectiveCols.slice(1);
    }
    const [fCol, fRow] = ((_b = selection.current) == null ? void 0 : _b.cell) ?? [];
    const range2 = (_c = selection.current) == null ? void 0 : _c.range;
    ...
    return React8.createElement(
      ...
      React8.createElement("tbody", { role: "rowgroup" }, visibleRows.map((row) => React8.createElement("tr", { role: "row", "aria-selected": selection.rows.hasIndex(row), key: row, "aria-rowindex": row + 2 }, effectiveCols.map((c) => {
        ...
        return React8.createElement("td", { key, role: "gridcell", "aria-colindex": col + 1 + colOffset, "aria-selected": selected, "aria-readonly": isInnerOnlyCell(cellContent) || !isReadWriteCell(cellContent), id, "data-testid": id, onClick: () => {
          ...
          var _a2, _b2;
          if (e.target === focusRef.current || ((_a2 = lastFocusedSubdomNode.current) == null ? void 0 : _a2[0]) === col && ((_b2 = lastFocusedSubdomNode.current) == null ? void 0 : _b2[1]) === row)
            return;
...
var DataGridDnd = (p2) => {
  ...
  const onMouseDownImpl = React9.useCallback((args) => {
    ...
    if (args.button === 0) {
      ...
      if (args.kind === "out-of-bounds" && args.isEdge && canResize) {
        const bounds = (_a = gridRef == null ? void 0 : gridRef.current) == null ? void 0 : _a.getBounds(columns.length - 1, -1);
        if (bounds !== void 0) {
        ...
        if (args.isEdge && canResize && canvas) {
          ...
          onColumnResizeStart == null ? void 0 : onColumnResizeStart(columns[col], width, col, width + (columns[col].growOffset ?? 0));
      ...
      if (resizeCol !== void 0) {
        if ((selectedColumns == null ? void 0 : selectedColumns.hasIndex(resizeCol)) === true) {
          for (const c of selectedColumns) {
            ...
            onColumnResize == null ? void 0 : onColumnResize(col, newSize, c, newSize + (col.growOffset ?? 0));
          }
        }
        const ns = offsetColumnSize(columns[resizeCol], lastResizeWidthRef.current, minColumnWidth, maxColumnWidth);
        onColumnResizeEnd == null ? void 0 : onColumnResizeEnd(columns[resizeCol], ns, resizeCol, ns + (columns[resizeCol].growOffset ?? 0));
        if (selectedColumns.hasIndex(resizeCol)) {
          for (const c of selectedColumns) {
            ...
            onColumnResizeEnd == null ? void 0 : onColumnResizeEnd(col, s, c, s + (col.growOffset ?? 0));
          }
        }
      }
      clearAll();
  ...
  const onMouseMove = React9.useCallback((event) => {
    ...
    if (dragCol !== void 0 && dragStartX !== void 0) {
      ...
      onColumnResize == null ? void 0 : onColumnResize(column, ns, resizeCol, ns + (column.growOffset ?? 0));
      ...
      if ((selectedColumns == null ? void 0 : selectedColumns.first()) === resizeCol) {
        for (const c of selectedColumns) {
          ...
          const col = columns[c];
          const s = offsetColumnSize(col, lastResizeWidthRef.current, minColumnWidth, maxColumnWidth);
          onColumnResize == null ? void 0 : onColumnResize(col, s, c, s + (col.growOffset ?? 0));
        }
      }
    }
  }, [
...
var ScrollRegionStyle = styled_default("div")({
...
var InfiniteScroller = (p2) => {
  ...
  const padders = [];
  const rightElementSticky = (rightElementProps == null ? void 0 : rightElementProps.sticky) ?? false;
  const rightElementFill = (rightElementProps == null ? void 0 : rightElementProps.fill) ?? false;
  ...
  const onScroll = React10.useCallback((scrollLeft, scrollTop) => {
    ...
    scrollLeft = (lock == null ? void 0 : lock[0]) ?? scrollLeft;
    scrollTop = (lock == null ? void 0 : lock[1]) ?? scrollTop;
    ...
    update({
      ...
      paddingRight: ((_a2 = rightWrapRef.current) == null ? void 0 : _a2.clientWidth) ?? 0
    });
  ...
  if (typeof window !== "undefined" && (((_a = lastProps.current) == null ? void 0 : _a.height) !== height || ((_b = lastProps.current) == null ? void 0 : _b.width) !== width)) {
  ...
  if ((width ?? 0) === 0 || (height ?? 0) === 0) return React10.createElement("div", {
    ref
  });
...
var GridScroller = (p2) => {
  ...
  return React11.createElement(
    InfiniteScroller,
    { scrollRef, className, kineticScrollPerfHack: experimental == null ? void 0 : experimental.kineticScrollPerfHack, preventDiagonalScrolling, draggable: isDraggable === true || typeof isDraggable === "string", scrollWidth: width + (paddingRight ?? 0), scrollHeight: height + (paddingBottom ?? 0), clientHeight, rightElement, paddingBottom, paddingRight, rightElementProps, update: onScrollUpdate, initialSize },
...
var SearchWrapper = styled_default("div")({
  name: "SearchWrapper",
  class: "gdg-seveqep",
  propsAsIs: false
});
...
var DataGridSearch = (p2) => {
  ...
  React12.useEffect(() => {
    ...
    if (searchResultsIn.length > 0) {
      setSearchStatus((cv) => ({
        ...
        selectedIndex: (cv == null ? void 0 : cv.selectedIndex) ?? -1
      }));
    } else {
  ...
  const beginSearch = React12.useCallback((str) => {
    ...
    const tick = async () => {
      ...
      const selectedIndex = ((_a = searchStatusRef.current) == null ? void 0 : _a.selectedIndex) ?? -1;
      setSearchStatus({
  ...
  const searchbox = React12.useMemo(() => {
    ...
    const rowsSearchedProgress = Math.floor(((searchStatus == null ? void 0 : searchStatus.rowsSearched) ?? 0) / rows * 100);
    const progressStyle = {
    ...
    return React12.createElement(
      ...
      React12.createElement(
        ...
        React12.createElement("button", { "aria-label": "Previous Result", "aria-hidden": !showSearch, tabIndex: showSearch ? void 0 : -1, onClick: onPrev, disabled: ((searchStatus == null ? void 0 : searchStatus.results) ?? 0) === 0 }, upArrow),
        React12.createElement("button", { "aria-label": "Next Result", "aria-hidden": !showSearch, tabIndex: showSearch ? void 0 : -1, onClick: onNext, disabled: ((searchStatus == null ? void 0 : searchStatus.results) ?? 0) === 0 }, downArrow),
...
var RenameInput = styled_default("input")({
  name: "RenameInput",
  class: "gdg-r17m35ur",
  propsAsIs: false,
  vars: {
  ...
  const setCurrent = import_react12.default.useCallback((value, expand, append, trigger) => {
    ...
    let newVal = {
      current: value === void 0 ? void 0 : {
        ...value,
        rangeStack: trigger === "drag" ? ((_a = gridSelection.current) == null ? void 0 : _a.rangeStack) ?? [] : []
      },
...
function useCellsForSelection(getCellsForSelectionIn, getCellContent, rowMarkerOffset, abortController, rows) {
  const getCellsForSelectionDirectWhenValid = React15.useCallback((rect) => {
    ...
    return (getCellsForSelectionIn == null ? void 0 : getCellsForSelectionIn(rect, abortController.signal)) ?? [];
...
function createTextBuffer(copyBuffer) {
  ...
  for (const row of copyBuffer) {
    ...
    for (const cell of row) {
      if (cell.format === "url") {
        line.push(((_a = cell.rawValue) == null ? void 0 : _a.toString()) ?? "");
    ...
    for (const cell of row) {
      ...
      if (cell.format === "url") {
        ...
        if (cell.format === "string-array") {
          ...
          lines.push(`<td gdg-raw-value=${formatHtmlAttributeContent(((_a = cell.rawValue) == null ? void 0 : _a.toString()) ?? "")} ${formatStr}>${formatHtmlTextContent(cell.formatted)}</td>`);
        }
      }
    }
    lines.push("</tr>");
    ...
    if (el instanceof HTMLTableElement || el.nodeName === "TBODY") {
      ...
      if (clone.querySelector("a") !== null) {
        current == null ? void 0 : current.push({
          ...
          rawValue: ((_a = clone.querySelector("a")) == null ? void 0 : _a.getAttribute("href")) ?? "",
...
function useRemAdjuster({ rowHeight: rowHeightIn, headerHeight: headerHeightIn, groupHeaderHeight: groupHeaderHeightIn, theme: themeIn, overscrollX: overscrollXIn, overscrollY: overscrollYIn, scaleToRem, remSize }) {
  const [rowHeight, headerHeight, groupHeaderHeight, theme, overscrollX, overscrollY] = import_react15.default.useMemo(() => {
    ...
    return [
      ...
      {
        ...themeIn,
        headerIconSize: ((themeIn == null ? void 0 : themeIn.headerIconSize) ?? bt.headerIconSize) * scaler,
        cellHorizontalPadding: ((themeIn == null ? void 0 : themeIn.cellHorizontalPadding) ?? bt.cellHorizontalPadding) * scaler,
        cellVerticalPadding: ((themeIn == null ? void 0 : themeIn.cellVerticalPadding) ?? bt.cellVerticalPadding) * scaler
      },
...
function useKeybindingsWithDefaults(keybindingsIn) {
  ...
  return import_react16.default.useMemo(() => {
    ...
    const withBackCompatApplied = {
      ...keys,
      goToNextPage: (keys == null ? void 0 : keys.goToNextPage) ?? (keys == null ? void 0 : keys.pageDown) ?? keybindingDefaults.goToNextPage,
      goToPreviousPage: (keys == null ? void 0 : keys.goToPreviousPage) ?? (keys == null ? void 0 : keys.pageUp) ?? keybindingDefaults.goToPreviousPage,
      goToFirstCell: (keys == null ? void 0 : keys.goToFirstCell) ?? (keys == null ? void 0 : keys.first) ?? keybindingDefaults.goToFirstCell,
      goToLastCell: (keys == null ? void 0 : keys.goToLastCell) ?? (keys == null ? void 0 : keys.last) ?? keybindingDefaults.goToLastCell,
      selectToFirstCell: (keys == null ? void 0 : keys.selectToFirstCell) ?? (keys == null ? void 0 : keys.first) ?? keybindingDefaults.selectToFirstCell,
      selectToLastCell: (keys == null ? void 0 : keys.selectToLastCell) ?? (keys == null ? void 0 : keys.last) ?? keybindingDefaults.selectToLastCell
    };
...
// node_modules/@glideapps/glide-data-grid/dist/esm/data-editor/data-editor.js
var DataGridOverlayEditor = React20.lazy(async () => await import("./data-grid-overlay-editor-ULDDPTVP.js"));
var idCounter = 0;
function getSpanStops(cells) {
  return (0, import_uniq.default)((0, import_flatten.default)((0, import_flatten.default)(cells).filter((c) => c.span !== void 0).map((c) => {
    var _a, _b;
    return (0, import_range2.default)((((_a = c.span) == null ? void 0 : _a[0]) ?? 0) + 1, (((_b = c.span) == null ? void 0 : _b[1]) ?? 0) + 1);
  })));
}
...
var DataEditorImpl = (p2, forwardedRef) => {
  ...
  const rowMarkers = (rowMarkersObj == null ? void 0 : rowMarkersObj.kind) ?? p2.rowMarkers ?? "none";
  const rowMarkerWidthRaw = (rowMarkersObj == null ? void 0 : rowMarkersObj.width) ?? p2.rowMarkerWidth;
  const rowMarkerStartIndex = (rowMarkersObj == null ? void 0 : rowMarkersObj.startIndex) ?? p2.rowMarkerStartIndex ?? 1;
  const rowMarkerTheme = (rowMarkersObj == null ? void 0 : rowMarkersObj.theme) ?? p2.rowMarkerTheme;
  const rowMarkerCheckboxStyle = (rowMarkersObj == null ? void 0 : rowMarkersObj.checkboxStyle) ?? "square";
  ...
  const drawHeader2 = whenDefined(drawHeaderIn, React20.useCallback((args, draw) => {
    return (drawHeaderIn == null ? void 0 : drawHeaderIn({ ...args, columnIndex: args.columnIndex - rowMarkerOffset }, draw)) ?? false;
  }, [drawHeaderIn, rowMarkerOffset]));
  const drawCell2 = whenDefined(drawCellIn, React20.useCallback((args, draw) => {
    return (drawCellIn == null ? void 0 : drawCellIn({ ...args, col: args.col - rowMarkerOffset }, draw)) ?? false;
  ...
  const highlightFocus = drawFocusRing ? (_a = gridSelection.current) == null ? void 0 : _a.cell : void 0;
  ...
  const getMangledCellContent = React20.useCallback(([col, row], forceStrict = false) => {
    ...
    if (isRowMarkerCol) {
      ...
      const maybeFirstColumnHint = isFirst ? (trailingRowOptions == null ? void 0 : trailingRowOptions.hint) ?? "" : "";
      const c = mangledColsRef.current[col];
      if (((_a2 = c == null ? void 0 : c.trailingRowOptions) == null ? void 0 : _a2.disabled) === true) {
        return loadingCell2;
      } else {
        const hint = ((_b2 = c == null ? void 0 : c.trailingRowOptions) == null ? void 0 : _b2.hint) ?? maybeFirstColumnHint;
        const icon = ((_c2 = c == null ? void 0 : c.trailingRowOptions) == null ? void 0 : _c2.addIcon) ?? (trailingRowOptions == null ? void 0 : trailingRowOptions.addIcon);
        return {
      ...
      if (forceStrict || (experimental == null ? void 0 : experimental.strict) === true) {
        ...
        const isSelected = outerCol === ((_e = (_d = vr.extras) == null ? void 0 : _d.selected) == null ? void 0 : _e[0]) && row === ((_f = vr.extras) == null ? void 0 : _f.selected[1]);
        let isInFreezeArea = false;
        if (((_g = vr.extras) == null ? void 0 : _g.freezeRegions) !== void 0) {
  ...
  const mangledGetGroupDetails = React20.useCallback((group) => {
    let result = (getGroupDetails == null ? void 0 : getGroupDetails(group)) ?? { name: group };
  ...
  const getCustomNewRowTargetColumn = React20.useCallback((col) => {
    var _a2, _b2;
    const customTargetColumn = ((_b2 = (_a2 = columns[col]) == null ? void 0 : _a2.trailingRowOptions) == null ? void 0 : _b2.targetColumn) ?? (trailingRowOptions == null ? void 0 : trailingRowOptions.targetColumn);
  ...
  const handleSelect = React20.useCallback((args) => {
    ...
    const [cellCol, cellRow] = ((_a2 = gridSelection.current) == null ? void 0 : _a2.cell) ?? [];
    if (args.kind === "cell") {
      ...
      if (col === 0 && hasRowMarkers) {
        ...
        if (onRowMoved !== void 0) {
          ...
          const postClick = (_b2 = renderer == null ? void 0 : renderer.onClick) == null ? void 0 : _b2.call(renderer, {
            ...args,
            cell: markerCell,
        ...
        if (cellCol !== col || cellRow !== row) {
          ...
          const startedFromLastSticky = lastRowSticky && gridSelection !== void 0 && ((_c2 = gridSelection.current) == null ? void 0 : _c2.cell[1]) === rows;
  ...
  const onMouseUp = React20.useCallback((args, isOutside) => {
    ...
    const handleMaybeClick = (a) => {
      ...
      if (!isPrevented.current) {
        ...
        switch (c.activationBehaviorOverride ?? cellActivationBehavior) {
          case "double-click":
          case "second-click": {
            if (((_c2 = (_b3 = mouse == null ? void 0 : mouse.previousSelection) == null ? void 0 : _b3.current) == null ? void 0 : _c2.cell) === void 0)
              break;
    ...
    if (args.isTouch) {
      ...
      if (args.isLongTouch === true) {
        if (args.kind === "cell" && itemsAreEqual((_b2 = gridSelection.current) == null ? void 0 : _b2.cell, args.location)) {
  ...
  const onMouseMoveImpl = React20.useCallback((args) => {
    ...
    setScrollDir((cv) => {
      ...
      if (args.scrollEdge[0] === (cv == null ? void 0 : cv[0]) && args.scrollEdge[1] === cv[1])
        return cv;
      return mouseState === void 0 || (((_a2 = mouseDownData.current) == null ? void 0 : _a2.location[0]) ?? 0) < rowMarkerOffset ? void 0 : args.scrollEdge;
    });
  ...
  const adjustSelectionOnScroll = React20.useCallback(() => {
    ...
    if (xDir === -1) {
      col = ((_b2 = (_a2 = visible.extras) == null ? void 0 : _a2.freezeRegion) == null ? void 0 : _b2.x) ?? visible.x;
    } else if (xDir === 1) {
  ...
  const deleteRange = React20.useCallback((r) => {
    ...
    (_d = gridRef.current) == null ? void 0 : _d.damage(editList.map((x) => ({ cell: x.location })));
  ...
  const handleFixedKeybindings = React20.useCallback((event) => {
    ...
    if (!overlayOpen && isHotkey(keys.clear, event, details)) {
      ...
      setGridSelection({
        ...
        rows: CompactSelection.empty(),
        current: {
          cell: ((_a2 = gridSelection.current) == null ? void 0 : _a2.cell) ?? [rowMarkerOffset, 0],
          range: {
            x: rowMarkerOffset,
            y: 0,
      ...
      (_b2 = searchInputRef == null ? void 0 : searchInputRef.current) == null ? void 0 : _b2.focus({ preventScroll: true });
      setShowSearchInner(true);
    } else if (isHotkey(keys.delete, event, details)) {
      const callbackResult = (onDelete == null ? void 0 : onDelete(gridSelection)) ?? true;
  ...
  const onPasteInternal = React20.useCallback(async (e) => {
    ...
    function pasteToCell(inner, target2, rawValue, formatted) {
      var _a3, _b3;
      const stringifiedRawValue = typeof rawValue === "object" ? (rawValue == null ? void 0 : rawValue.join("\n")) ?? "" : (rawValue == null ? void 0 : rawValue.toString()) ?? "";
      if (!isInnerOnlyCell(inner) && isReadWriteCell(inner) && inner.readonly !== true) {
        ...
        if (r.kind === GridCellKind.Custom) {
          ...
          const newVal = (_a3 = r.onPaste) == null ? void 0 : _a3.call(r, stringifiedRawValue, inner.data);
          if (newVal === void 0)
            return void 0;
          return {
            location: target2,
          ...
          const newVal = (_b3 = r.onPaste) == null ? void 0 : _b3.call(r, stringifiedRawValue, inner, {
            formatted,
    ...
    if (focused && target !== void 0) {
      ...
      do {
        if (onPaste === void 0) {
          ...
          const rawValue = text ?? (data == null ? void 0 : data.map((r) => r.map((cb) => cb.rawValue).join("	")).join("	")) ?? "";
        ...
        if (onPaste === false || typeof onPaste === "function" && (onPaste == null ? void 0 : onPaste([target[0] - rowMarkerOffset, target[1]], data.map((r) => r.map((cb) => {
          var _a3;
          return ((_a3 = cb.rawValue) == null ? void 0 : _a3.toString()) ?? "";
        })))) !== true) {
          return;
        }
      ...
      mangledOnCellsEdited(editList);
      (_c2 = gridRef.current) == null ? void 0 : _c2.damage(editList.map((c) => ({
        cell: c.location
      })));
    }
  }, [
  ...
  const [outCol, outRow] = ((_c = gridSelectionOuter == null ? void 0 : gridSelectionOuter.current) == null ? void 0 : _c.cell) ?? [];
  const scrollToRef = React20.useRef(scrollTo);
  scrollToRef.current = scrollTo;
  React20.useLayoutEffect(() => {
    var _a2, _b2, _c2, _d;
    if (!hasJustScrolled.current && outCol !== void 0 && outRow !== void 0 && (outCol !== ((_b2 = (_a2 = expectedExternalGridSelection.current) == null ? void 0 : _a2.current) == null ? void 0 : _b2.cell[0]) || outRow !== ((_d = (_c2 = expectedExternalGridSelection.current) == null ? void 0 : _c2.current) == null ? void 0 : _d.cell[1]))) {
  ...
  const mangledVerticalBorder = React20.useCallback((col) => {
    return typeof verticalBorder === "boolean" ? verticalBorder : (verticalBorder == null ? void 0 : verticalBorder(col - rowMarkerOffset)) ?? true;
  ...
  React20.useImperativeHandle(forwardedRef, () => ({
    ...
    getBounds: (col, row) => {
      ...
      return (_a2 = gridRef.current) == null ? void 0 : _a2.getBounds((col ?? 0) + rowMarkerOffset, row);
    },
    focus: () => {
      var _a2;
  ...
  const [idealWidth, idealHeight] = React20.useMemo(() => {
    let h;
    const scrollbarWidth = (experimental == null ? void 0 : experimental.scrollbarWidthOverride) ?? getScrollBarWidth();
  ...
  return React20.createElement(
    ...
    React20.createElement(
      ...
      overlay !== void 0 && React20.createElement(
        React20.Suspense,
        { fallback: null },
        React20.createElement(DataGridOverlayEditor, { ...overlay, validateCell, bloom: editorBloom, id: overlayID, getCellRenderer, className: (experimental == null ? void 0 : experimental.isSubGrid) === true ? "click-outside-ignore" : void 0, provideEditor, imageEditorOverride, onFinishEditing, markdownDivCreateNode, isOutsideClick })
      )
    )
  );
};
...
var booleanCellRenderer = {
  getAccessibilityString: (c) => {
    var _a;
    return ((_a = c.data) == null ? void 0 : _a.toString()) ?? "false";
  },
...
var BubblesOverlayEditorStyle = styled_default("div")({
...
var DrilldownOverlayEditorStyle = styled_default("div")({
...
function drawImage(args, data, rounding, contentAlign) {
  ...
  if (contentAlign === "right")
    drawX = Math.floor(x + w2 - theme.cellHorizontalPadding - totalWidth);
  else if (contentAlign === "center")
...
var MarkdownOverlayEditorStyle = styled_default("div")({
...
var markdownCellRenderer = {
  getAccessibilityString: (c) => {
    var _a;
    return ((_a = c.data) == null ? void 0 : _a.toString()) ?? "";
  },
...
function drawMarkerRowCell(args, index, checked, markerKind, drawHandle, style) {
  ...
  if (markerKind !== "number" && checkedboxAlpha > 0) {
    ...
    drawCheckbox(ctx, theme, checked, drawHandle ? x + offsetAmount : x, y, drawHandle ? width - offsetAmount : width, height, true, void 0, void 0, 18, "center", style);
    if (drawHandle) {
      ctx.globalAlpha = hoverAmount;
      ctx.beginPath();
...
var NumberOverlayEditor = React28.lazy(async () => await import("./number-overlay-editor-LLUPATV2.js"));
var numberCellRenderer = {
  ...
  provideEditor: () => (p2) => {
    ...
    return React28.createElement(
      React28.Suspense,
      { fallback: null },
      React28.createElement(NumberOverlayEditor, { highlight: isHighlighted, disabled: value.readonly === true, value: value.data, fixedDecimals: value.fixedDecimals, allowNegative: value.allowNegative, thousandSeparator: value.thousandSeparator, decimalSeparator: value.decimalSeparator, validatedSelection, onChange: (x) => onChange({
        ...value,
...
var UriOverlayEditorStyle = styled_default("div")({
...
classnames/index.js:
  ...
  *)
*/
//# sourceMappingURL=@glideapps_glide-data-grid.js.map
