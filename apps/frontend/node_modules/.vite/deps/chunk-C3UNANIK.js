...
var _CompactSelection = class _CompactSelection {
  constructor(items) {
...
__publicField(_CompactSelection, "empty", () => {
  return emptyCompactSelection ?? (emptyCompactSelection = new _CompactSelection([]));
});
__publicField(_CompactSelection, "fromSingleSelection", (selection) => {
...
var ClickOutsideContainer = class extends React2.PureComponent {
  constructor() {
    super(...arguments);
    __publicField(this, "wrapperRef", React2.createRef());
    __publicField(this, "clickOutside", (event) => {
...
//# sourceMappingURL=chunk-C3UNANIK.js.map
